                    ...
                    <div class="author-wrpp">
                        ...
                        <div class="authorPage-content">
                            ...
                            <div class="author-date">
                                <a href=" {{ url('news/details/'.$item->id.'/'.$item->news_title_slug) }}"> {{ $item->user->name }}</a> <span> <i class="las la-clock"></i>
...
#e1dfdf; border-radius: 5px;">
                    <figure class="authorPage-image">
                        <img alt="" src="{{ (!empty($reporter->photo)) ? url('upload/admin_images/'.$reporter->photo): url('upload/no_image.jpg') }}" class="avatar avatar-96 photo" height="96" width="96" loading="lazy">
                    </figure>
