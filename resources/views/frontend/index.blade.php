                ...
                <div class="col-lg-5 col-md-5">
                    <div class="black-bg">
                        <div class="secSeven-image">
                            <a href=" "><img class="lazyload" src="assets/images/lazy.jpg"></a> <a href=" "
                        ...
                        <div class="secSeven-details">
                            ...
                            ticket sales matter? According to Johar, ticket sales is of utmost<a href=" "> More..</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-7 col-md-7">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-4">
                ...
                <h2 class="themesBazar_cat04"> <a href=" "> <i class="las la-align-justify"></i> ENTERTAINMENT </a>
                </h2>
            ...
            <div class="col-lg-4 col-md-4">
                ...
                <h2 class="themesBazar_cat04"> <a href=" "> <i class="las la-align-justify"></i> FACEBOOK NEWS </a>
                </h2>
                ...
                <div class="white-bg">
                    <div class="secFive-smallItem">
                        <div class="secFive-smallImg">
                            ...
                            <h5 class="secFive_title2">
                                <a href="https://www.youtube.com/watch?v=z3ZM1TUNoUY" class="popup"> Pakistan set up
                                    Asia Cup final </a>
                            </h5>
                        </div>
                    </div>
                    <div class="secFive-smallItem">
                        <div class="secFive-smallImg">
                            ...
                            <a href="https://www.youtube.com/watch?v=XTUg53YVaqQ" class="home-video-icon popup"><i
                                    class="las la-video"></i></a>
                            <h5 class="secFive_title2">
                                <a href="https://www.youtube.com/watch?v=XTUg53YVaqQ" class="popup"> Pakistan set up
                                    Asia Cup final</a>
                            </h5>
                        </div>
                    </div>
                    <div class="secFive-smallItem">
                        <div class="secFive-smallImg">
                            ...
                            <a href="https://www.youtube.com/watch?v=qr3CeJJ_mkM" class="home-video-icon popup"><i
                                    class="las la-video"></i></a>
                            <h5 class="secFive_title2">
                                <a href="https://www.youtube.com/watch?v=qr3CeJJ_mkM" class="popup"> Pakistan set up
                                    Asia Cup final </a>
                            </h5>
                        </div>
                    </div>
                    <div class="secFive-smallItem">
                        <div class="secFive-smallImg">
                            ...
                            <a href="https://www.youtube.com/watch?v=BU12aHPjoNo" class="home-video-icon popup"><i
                                    class="las la-video"></i></a>
                            <h5 class="secFive_title2">
                                <a href="https://www.youtube.com/watch?v=BU12aHPjoNo" class="popup"> Pakistan set up
                                    Asia Cup final </a>
                            </h5>
                        </div>
                    </div>
                    <div class="secFive-smallItem">
                        <div class="secFive-smallImg">
                            ...
                            <a href="https://www.youtube.com/watch?v=TH0kuBADgSI" class="home-video-icon popup"><i
                                    class="las la-video"></i></a>
                            <h5 class="secFive_title2">
                                <a href="https://www.youtube.com/watch?v=TH0kuBADgSI" class="popup"> Pakistan set up
                                    Asia Cup final </a>
                            </h5>
                        </div>
                    </div>
