    ...
    <div class="row">
        <div class="col-lg-8 col-md-8">
            ...
            <div class="row g-2">
                <div class="col-lg-1 col-md-2 ">
                    <div class="reportar-image">
                        <img src="{{!empty($news->user->photo) ? asset('upload/admin_images/' . $news->user->photo) : asset('upload/no_image.jpg')}}">
                    </div>
                </div>
            ...
            <div class="single-image">
                <a href=" "><img class="lazyload" src="{{asset('upload/news/' . $news->image)}}"></a>
