                        ...
                        <form id="myForm" method="post" action="{{ route('role.permission.store') }}">
                            ...
                            <div class="row">
                                <div class="col-3">
                                    ...
                                    <div class="form-check mb-2 form-check-primary">
                                        <input class="form-check-input" type="checkbox" value="" id="customcheckgroup{{$key}}">
                                ...
                                <div class="col-9">
                                    ...
                                    <div class="form-check mb-2 form-check-primary">
                                        <input class="form-check-input" name="permission[]" type="checkbox" value="{{ $permission->id }}" id="customcheck{{ $permission->id }}">
