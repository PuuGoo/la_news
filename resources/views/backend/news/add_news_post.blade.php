    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form id="myForm" method="post" action="{{route('news.post.store')}}" enctype="multipart/form-data" >
                            @csrf
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="inputEmail4" name="news_title">
                                </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea name="news_details" id="myeditorinstance"></textarea>
                                </div>

                                <div class="col-md-12 mb-3">
                                    <label for="inputEmail4" class="form-label">Tags</label>
                                    <input name="tags" type="text" class="selectize-close-btn" value="awesome">
                                </div>

                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-check mb-2 form-check-primary">
                                            <input class="form-check-input" type="checkbox" value="1" id="customckeck1" name="breaking_news">
                                            <label class="form-check-label" for="customckeck1">Breaking News</label>
                                        </div>

                                        <div class="form-check mb-2 form-check-primary">
                                            <input class="form-check-input" type="checkbox" value="1" id="customckeck2" name="top_slider">
