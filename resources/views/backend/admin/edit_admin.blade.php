                        ...
                        <form id="myForm" method="post" action="{{route('admin.update')}}">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="inputEmail4" name="username" value="{{$adminuser->username}}">
                                </div>

                                <div class="form-group col-md-6 mb-3">
                                    <label for="inputEmail4" class="form-label">Name</label>
                                    <input type="text" class="form-control" id="inputEmail4" name="name" value="{{$adminuser->name}}">
                                </div>

                                <div class=" form-group col-md-6 mb-3">
                                    <label for="inputEmail4" class="form-label">Email</label>
                                    <input type="email" class="form-control" id="inputEmail4" name="email" value="{{$adminuser->email}}">
                                </div>
