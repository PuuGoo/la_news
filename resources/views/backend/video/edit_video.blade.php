                        ...
                        <form id="myForm" method="post" action="{{route('update.video.gallery')}}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="inputEmail4" name="video_title" value="{{$video->video_title}}">
                                </div>

                                <div class="form-group col-md-6 mb-3">
                                    <label for="inputEmail4" class="form-label">Video Url</label>
                                    <input type="text" class="form-control" id="inputEmail4" name="video_url" value="{{$video->video_url}}">
                                </div>
                                ...
                                <div class="form-group col-md-6 mb-3">
                                    ...
                                    <img id="showImage" src="{{asset('upload/video/' . $video->video_image )}}" class="rounded-circle avatar-lg img-thumbnail"
                                        alt="profile-image">
                                </div>
